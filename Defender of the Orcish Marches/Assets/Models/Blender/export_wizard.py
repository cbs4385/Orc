"""
Blender 4.x script — Remove preview objects and export Wizard as FBX.
Run this AFTER generate_wizard.py has been run.
"""

import bpy
import os

OUTPUT_PATH = r"C:\Users\chris\source\repos\Orc\Defender of the Orcish Marches\Assets\Models\Wizard.fbx"
